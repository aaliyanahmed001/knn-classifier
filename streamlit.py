...
st.title("🚀 Crypto Data Engineering & Prediction")
...
st.header(f"📊 Market Insights: {selected_coin}")
...
st.header(f"📈 Price Trend: {selected_coin} Future Prediction")
...
if prediction > current_price:
    st.success(f"✅ BULLISH: Predicted ${prediction:.2f}")
else:
